  ...
  static defineSchema() {
    return {
      items: new ArrayField(new SchemaField({
        ...
        optional: new BooleanField({label: "SENTIUS.AdvancementItemGrantOptional"})
      }), {required: true, label: "DOCUMENT.Items"}),
      optional: new BooleanField({
        required: true, label: "SENTIUS.AdvancementItemGrantOptional", hint: "SENTIUS.AdvancementItemGrantOptionalHint"
      }),
