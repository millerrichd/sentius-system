  ...
  static defineSchema() {
    return {
      ...
      type: new StringField({
        required: true, initial: "string", choices: TYPES, label: "SENTIUS.AdvancementScaleValueTypeLabel"
      }),
      distance: new SchemaField({ units: new StringField({required: true, label: "SENTIUS.MovementUnits"}) }),
...
export class ScaleValueType extends foundry.abstract.DataModel {
  ...
  static get metadata() {
    return {
      label: "SENTIUS.AdvancementScaleValueTypeString",
      hint: "SENTIUS.AdvancementScaleValueTypeHintString",
      isNumeric: false
    };
  }
...
export class ScaleValueTypeNumber extends ScaleValueType {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "SENTIUS.AdvancementScaleValueTypeNumber",
      hint: "SENTIUS.AdvancementScaleValueTypeHintNumber",
      isNumeric: true
    });
  }
...
export class ScaleValueTypeCR extends ScaleValueTypeNumber {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "SENTIUS.AdvancementScaleValueTypeCR",
      hint: "SENTIUS.AdvancementScaleValueTypeHintCR"
    });
  }
...
export class ScaleValueTypeDice extends ScaleValueType {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "SENTIUS.AdvancementScaleValueTypeDice",
      hint: "SENTIUS.AdvancementScaleValueTypeHintDice"
    });
  }
  ...
  get mods() {
    ...
    return this.modifiers.reduce((acc, mod) => {
      return acc + (sentius.utils.isValidDieModifier(mod) ? mod : "");
    }, "");
  }
...
export class ScaleValueTypeDistance extends ScaleValueTypeNumber {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "SENTIUS.AdvancementScaleValueTypeDistance",
      hint: "SENTIUS.AdvancementScaleValueTypeHintDistance"
    });
  }
