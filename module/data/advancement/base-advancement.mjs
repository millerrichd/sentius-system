  ...
  static defineSchema() {
    return {
      ...
      level: new NumberField({
        integer: true, initial: this.metadata?.multiLevel ? undefined : 0, min: 0, label: "SENTIUS.Level"
      }),
      title: new StringField({initial: undefined, label: "SENTIUS.AdvancementCustomTitle"}),
      hint: new StringField({label: "SENTIUS.AdvancementHint"}),
      icon: new FilePathField({
        initial: undefined, categories: ["IMAGE"], label: "SENTIUS.AdvancementCustomIcon", base64: true
      }),
      classRestriction: new StringField({
        initial: undefined, choices: ["primary", "secondary"], label: "SENTIUS.AdvancementClassRestriction"
      })
    };
  }
