  ...
  static defineSchema() {
    return {
      choices: new MappingField(new SchemaField({
        ...
        replacement: new BooleanField({label: "SENTIUS.AdvancementItemChoiceReplacement"})
      }), {
        hint: "SENTIUS.AdvancementItemChoiceLevelsHint"
      }),
      allowDrops: new BooleanField({
        initial: true, label: "SENTIUS.AdvancementConfigureAllowDrops",
        hint: "SENTIUS.AdvancementConfigureAllowDropsHint"
      }),
      type: new StringField({
        blank: false, nullable: true, initial: null,
        label: "SENTIUS.AdvancementItemChoiceType", hint: "SENTIUS.AdvancementItemChoiceTypeHint"
      }),
      ...
      restriction: new SchemaField({
        type: new StringField({label: "SENTIUS.Type"}),
        subtype: new StringField({label: "SENTIUS.Subtype"}),
        level: new StringField({label: "SENTIUS.SpellLevel"})
      })
    };
  }
