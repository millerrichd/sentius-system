...
export default class SpellListJournalPageData extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      type: new StringField({
        initial: "class", label: "JOURNALENTRYPAGE.SENTIUS.SpellList.Type.Label"
      }),
      identifier: new IdentifierField({label: "SENTIUS.Identifier"}),
      grouping: new StringField({
        initial: "level", choices: this.GROUPING_MODES,
        label: "JOURNALENTRYPAGE.SENTIUS.SpellList.Grouping.Label",
        hint: "JOURNALENTRYPAGE.SENTIUS.SpellList.Grouping.Hint"
      }),
      description: new SchemaField({
        value: new HTMLField({textSearch: true, label: "SENTIUS.Description"})
      }),
      spells: new SetField(new StringField(), {label: "SENTIUS.ItemTypeSpellPl"}),
      unlinkedSpells: new ArrayField(new SchemaField({
        ...
        system: new SchemaField({
          level: new NumberField({min: 0, integer: true, label: "SENTIUS.Level"}),
          school: new StringField({label: "SENTIUS.School"})
        }),
        source: new SourceField({license: false, revision: false, rules: false, uuid: new StringField()})
      }), {label: "JOURNALENTRYPAGE.SENTIUS.SpellList.UnlinkedSpells.Label"})
    };
  }
  ...
  static GROUPING_MODES = {
    none: "JOURNALENTRYPAGE.SENTIUS.SpellList.Grouping.None",
    alphabetical: "JOURNALENTRYPAGE.SENTIUS.SpellList.Grouping.Alphabetical",
    level: "JOURNALENTRYPAGE.SENTIUS.SpellList.Grouping.Level",
    school: "JOURNALENTRYPAGE.SENTIUS.SpellList.Grouping.School"
  };
