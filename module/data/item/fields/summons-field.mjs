  ...
  static defineSchema() {
    return {
      bonuses: new SchemaField({
        ac: new FormulaField({
          label: "SENTIUS.Summoning.Bonuses.ArmorClass.Label", hint: "SENTIUS.Summoning.Bonuses.ArmorClass.hint"
        }),
        hd: new FormulaField({
          label: "SENTIUS.Summoning.Bonuses.HitDice.Label", hint: "SENTIUS.Summoning.Bonuses.HitDice.hint"
        }),
        hp: new FormulaField({
          label: "SENTIUS.Summoning.Bonuses.HitPoints.Label", hint: "SENTIUS.Summoning.Bonuses.HitPoints.hint"
        }),
        attackDamage: new FormulaField({
          label: "SENTIUS.Summoning.Bonuses.Attack.Label", hint: "SENTIUS.Summoning.Bonuses.Attack.Hint"
        }),
        saveDamage: new FormulaField({
          label: "SENTIUS.Summoning.Bonuses.Saves.Label", hint: "SENTIUS.Summoning.Bonuses.Saves.Hint"
        }),
        healing: new FormulaField({
          label: "SENTIUS.Summoning.Bonuses.Healing.Label", hint: "SENTIUS.Summoning.Bonuses.Healing.Hint"
        })
      }),
      classIdentifier: new IdentifierField(),
      creatureSizes: new SetField(new StringField(), {
        label: "SENTIUS.Summoning.CreatureSizes.Label", hint: "SENTIUS.Summoning.CreatureSizes.Hint"
      }),
      creatureTypes: new SetField(new StringField(), {
        label: "SENTIUS.Summoning.CreatureTypes.Label", hint: "SENTIUS.Summoning.CreatureTypes.Hint"
      }),
      match: new SchemaField({
        attacks: new BooleanField({
          label: "SENTIUS.Summoning.Match.Attacks.Label", hint: "SENTIUS.Summoning.Match.Attacks.Hint"
        }),
        proficiency: new BooleanField({
          label: "SENTIUS.Summoning.Match.Proficiency.Label", hint: "SENTIUS.Summoning.Match.Proficiency.Hint"
        }),
        saves: new BooleanField({
          label: "SENTIUS.Summoning.Match.Saves.Label", hint: "SENTIUS.Summoning.Match.Saves.Hint"
        })
      }),
      mode: new StringField({label: "SENTIUS.Summoning.Mode.Label", hint: "SENTIUS.Summoning.Mode.Hint"}),
      ...
      prompt: new BooleanField({
        initial: true, label: "SENTIUS.Summoning.Prompt.Label", hint: "SENTIUS.Summoning.Prompt.Hint"
      })
    };
  }
}
