...
export default class SubclassData extends ItemDataModel.mixin(ItemDescriptionTemplate) {
  ...
  static defineSchema() {
    return this.mergeSchema(super.defineSchema(), {
      ...
      classIdentifier: new IdentifierField({
        required: true, label: "SENTIUS.ClassIdentifier", hint: "SENTIUS.ClassIdentifierHint"
      }),
  ...
  static get compendiumBrowserFilters() {
    return new Map([
      ["class", {
        ...
        type: "set",
        config: {
          choices: sentius.registry.classes.choices,
  ...
  async getSheetData(context) {
    ...
    context.parts = ["sentius.details-subclass", "sentius.details-spellcasting"];
  }
