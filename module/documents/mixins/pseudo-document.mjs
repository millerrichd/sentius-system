...
export default function PseudoDocumentMixin(Base) {
  class PseudoDocument extends Base {
    ...
    static get documentConfig() {
      return CONFIG.SENTIUS[`${this.documentName.toLowerCase()}Types`];
    }
    ...
    static async createDialog(data={}, { parent, types=null, ...options }={}) {
      ...
      const label = game.i18n.localize(`DOCUMENT.SENTIUS.${this.documentName}`);
      ...
      return Dialog.prompt({
        ...
        callback: html => {
          ...
          if ( !form.checkValidity() ) {
            throw new Error(game.i18n.format("DOCUMENT.SENTIUS.Warning.SelectType", { name: label }));
          }
