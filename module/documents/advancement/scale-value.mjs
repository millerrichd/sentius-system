...
export default class ScaleValueAdvancement extends Advancement {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      ...
      typeIcon: "systems/sentius/icons/svg/scale-value.svg",
      title: game.i18n.localize("SENTIUS.AdvancementScaleValueTitle"),
      hint: game.i18n.localize("SENTIUS.AdvancementScaleValueHint"),
      multiLevel: true,
      apps: {
