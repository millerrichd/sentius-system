...
export default class HitPointsAdvancement extends Advancement {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      ...
      typeIcon: "systems/sentius/icons/svg/hit-points.svg",
      title: game.i18n.localize("SENTIUS.AdvancementHitPointsTitle"),
      hint: game.i18n.localize("SENTIUS.AdvancementHitPointsHint"),
      multiLevel: true,
      apps: {
  ...
  /** @inheritDoc */
  get levels() {
    return Array.fromRange(CONFIG.SENTIUS.maxLevel + 1).slice(1);
  }
  ...
  #getApplicableValue(value) {
    const abilityId = CONFIG.SENTIUS.defaultAbilities.hitPoints || "con";
