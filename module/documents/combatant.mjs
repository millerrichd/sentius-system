...
export default class Combatant5e extends Combatant {
  ...
  async recoverCombatUses(periods) {
     ...
     * @function sentius.preCombatRecovery
     * @memberof hookEvents
     ...
     */
    if ( Hooks.call("sentius.preCombatRecovery", this, periods) === false ) return;

    const updates = { actor: {}, item: [] };
    await this.actor?.system.recoverCombatUses?.(periods, updates);

    // TODO: If https://github.com/foundryvtt/sentius/issues/3214 is implemented, this is where
     ...
     * @function sentius.combatRecovery
     * @memberof hookEvents
     * @param {Combatant5e} combatant                      Combatant that is being recovered.
     ...
     */
    if ( Hooks.call("sentius.combatRecovery", this, periods, updates) === false ) return;
     ...
     * @function sentius.postCombatRecovery
     * @memberof hookEvents
     * @param {Combatant5e} combatant  Combatant that is being recovered.
     * @param {Set<string>} periods    Periods that were recovered.
     */
    Hooks.callAll("sentius.postCombatRecovery", this, periods);
  }
