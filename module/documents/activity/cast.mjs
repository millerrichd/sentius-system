...
export default class CastActivity extends ActivityMixin(CastActivityData) {
   ...
   */
  static ENCHANTMENT_ID = staticID("sentiusspellchanges");

  /* -------------------------------------------- */

  /** @inheritDoc */
  static LOCALIZATION_PREFIXES = [...super.LOCALIZATION_PREFIXES, "SENTIUS.CAST"];
  ...
  static metadata = Object.freeze(
    foundry.utils.mergeObject(super.metadata, {
      type: "cast",
      img: "systems/sentius/icons/svg/activity/cast.svg",
      title: "SENTIUS.CAST.Title",
  ...
  get cachedSpell() {
    return this.actor?.sourcedItems.get(this.spell.uuid, { legacy: false })
      ?.find(i => i.getFlag("sentius", "cachedFor") === this.relativeUUID);
  }
  ...
  async use(usage={}, dialog={}, message={}) {
     ...
     * @function sentius.preUseLinkedSpell
     * @memberof hookEvents
     ...
     */
    if ( Hooks.call("sentius.preUseLinkedSpell", this, usage, dialog, message) === false ) return;
     ...
     * @function sentius.postUseLinkedSpell
     * @memberof hookEvents
     ...
     */
    if ( results ) Hooks.callAll("sentius.postUseLinkedSpell", this, usage, results);
    ...
    return originalSpell.clone({
      effects: [
        ...originalSpell.effects.map(e => e.toObject()),
        {
          ...
          type: "enchantment",
          name: game.i18n.localize("SENTIUS.CAST.Enchantment.Name"),
          img: "systems/sentius/icons/svg/activity/cast.svg",
          origin: this.uuid,
