...
export default class SaveActivity extends ActivityMixin(SaveActivityData) {
  ...
  /** @inheritDoc */
  static LOCALIZATION_PREFIXES = [...super.LOCALIZATION_PREFIXES, "SENTIUS.SAVE"];
  ...
  static metadata = Object.freeze(
    foundry.utils.mergeObject(super.metadata, {
      type: "save",
      img: "systems/sentius/icons/svg/activity/save.svg",
      title: "SENTIUS.SAVE.Title.one",
  ...
  _usageChatButtons(message) {
    ...
    for ( const abilityId of this.save.ability ) {
      const ability = CONFIG.SENTIUS.abilities[abilityId]?.label ?? "";
      buttons.push({
        label: `
          <span class="visible-dc">${game.i18n.format("SENTIUS.SavingThrowDC", { dc, ability })}</span>
          <span class="hidden-dc">${game.i18n.format("SENTIUS.SavePromptTitle", { ability })}</span>
        `,
