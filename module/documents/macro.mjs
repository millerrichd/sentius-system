  ...
  switch ( dropData.type ) {
    case "Item":
      ...
      foundry.utils.mergeObject(macroData, {
        name: itemData.name,
        img: itemData.img,
        command: `sentius.documents.macro.rollItem("${itemData._source.name}")`,
        flags: {"sentius.itemMacro": true}
      });
      break;
    case "ActiveEffect":
      ...
      foundry.utils.mergeObject(macroData, {
        ...
        img: effectData.img,
        command: `sentius.documents.macro.toggleEffect("${effectData.name}")`,
        flags: {"sentius.effectMacro": true}
      });
      break;
    default:
      return;
