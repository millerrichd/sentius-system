...
export async function damageRoll({
  ...
  const rollConfig = {
    ...
    critical: {
      ...
      multiplyNumeric: multiplyNumeric ?? game.settings.get("sentius", "criticalDamageModifiers"),
      powerfulCritical: powerfulCritical ?? game.settings.get("sentius", "criticalDamageMaxDice")
    },
