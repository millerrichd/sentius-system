...
export default class AttackRollConfigurationDialog extends D20RollConfigurationDialog {
  ...
  async _prepareConfigurationContext(context, options) {
    ...
    const optionsFields = [
      { key: "attackMode", label: "SENTIUS.ATTACK.Mode.Label", options: this.options.attackModeOptions },
      { key: "ammunition", label: "SENTIUS.CONSUMABLE.Type.Ammunition.Label", options: this.options.ammunitionOptions },
      { key: "mastery", label: "SENTIUS.WEAPON.Mastery.Label", options: this.options.masteryOptions }
    ];
    context.fields = [
