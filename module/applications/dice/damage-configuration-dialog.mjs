...
export default class DamageRollConfigurationDialog extends RollConfigurationDialog {
  ...
  static PARTS = {
    ...super.PARTS,
    formulas: {
      template: "systems/sentius/templates/dice/damage-formulas.hbs"
    }
  };
  ...
  async _prepareButtonsContext(context, options) {
    ...
    context.buttons = {
      critical: {
        ...
        label: game.i18n.localize("SENTIUS.CriticalHit")
      },
      normal: {
        default: !defaultCritical,
        icon: '<i class="fa-solid fa-dice" inert></i>',
        label: game.i18n.localize(allowCritical ? "SENTIUS.Normal" : "SENTIUS.Roll")
      }
    };
  ...
  async _prepareFormulasContext(context, options) {
    ...
    const allTypes = foundry.utils.mergeObject(CONFIG.SENTIUS.damageTypes, CONFIG.SENTIUS.healingTypes, { inplace: false });
