...
export default class CreatureTypeConfig extends BaseConfigSheet {
  ...
  static PARTS = {
    config: {
      template: "systems/sentius/templates/shared/config/creature-type-config.hbs"
    }
  };
  ...
  /** @override */
  get title() {
    return game.i18n.localize("SENTIUS.CreatureType");
  }
  ...
  async _preparePartContext(partId, context, options) {
    ...
    context.swarmOptions = [
      { value: "", label: "" },
      ...Object.entries(CONFIG.SENTIUS.actorSizes).map(([value, { label }]) => ({ value, label })).reverse()
    ];
    context.typeOptions = Object.entries(CONFIG.SENTIUS.creatureTypes)
