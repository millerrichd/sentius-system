...
export default class HitPointsFlow extends AdvancementFlow {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/sentius/templates/advancement/hit-points-flow.hbs"
    });
  }
  ...
  _updateObject(event, formData) {
    ...
    throw new Advancement.ERROR(game.i18n.localize(`SENTIUS.AdvancementHitPoints${errorType}Error`));
  }
