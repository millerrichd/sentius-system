...
export default class AdvancementConfirmationDialog extends Dialog {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/sentius/templates/advancement/advancement-confirmation-dialog.hbs",
      jQuery: false
    });
  }
  ...
  static forDelete(item) {
    return this.createDialog(
      item,
      game.i18n.localize("SENTIUS.AdvancementDeleteConfirmationTitle"),
      game.i18n.localize("SENTIUS.AdvancementDeleteConfirmationMessage"),
      {
  ...
  static forLevelDown(item) {
    return this.createDialog(
      item,
      game.i18n.localize("SENTIUS.AdvancementLevelDownConfirmationTitle"),
      game.i18n.localize("SENTIUS.AdvancementLevelDownConfirmationMessage"),
      {
        icon: '<i class="fas fa-sort-numeric-down-alt"></i>',
        label: game.i18n.localize("SENTIUS.LevelActionDecrease")
      }
    );
  }
