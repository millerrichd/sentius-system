...
export default class CompendiumBrowserSettingsConfig extends Application5e {
  ...
  static DEFAULT_OPTIONS = {
    ...
    tag: "form",
    window: {
      title: "SENTIUS.CompendiumBrowser.Sources.Label",
  ...
  static PARTS = {
    sidebar: {
      id: "sidebar",
      template: "systems/sentius/templates/compendium/sources-sidebar.hbs"
    },
    packs: {
      id: "packs",
      template: "systems/sentius/templates/compendium/sources-packs.hbs"
    }
  };
  ...
  async _onToggleSource(target) {
    ...
    const setting = { ...game.settings.get("sentius", "packSourceConfiguration"), ...packs };
    await game.settings.set("sentius", "packSourceConfiguration", setting);
    this.render();
  }
  ...
  static collateSources() {
    ...
    const setting = game.settings.get("sentius", "packSourceConfiguration");
