...
export default class ModuleArtSettingsConfig extends FormApplication {
  ...
  constructor(object={}, options={}) {
    object = foundry.utils.mergeObject(game.settings.get("sentius", "moduleArtConfiguration"), object, {inplace: false});
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      title: game.i18n.localize("SENTIUS.ModuleArtConfigL"),
      id: "module-art-config",
      template: "systems/sentius/templates/apps/module-art-config.hbs",
      popOut: true,
      width: 600,
      height: "auto"
    });
  ...
  async _updateObject(event, formData) {
    await game.settings.set("sentius", "moduleArtConfiguration", foundry.utils.expandObject(formData));
