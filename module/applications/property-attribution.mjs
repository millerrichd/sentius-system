...
export default class PropertyAttribution extends Application {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      classes: ["sentius", "property-attribution"],
      template: "systems/sentius/templates/apps/property-attribution.hbs",
      width: 320,
      height: "auto"
    });
  }
  ...
  getPropertyLabel(property) {
    ...
    if ( parts[0] === "abilities" && parts[1] ) {
      return CONFIG.SENTIUS.abilities[parts[1]]?.label ?? property;
    } else if ( (property === "attributes.ac.dex") && CONFIG.SENTIUS.abilities.dex ) {
      return CONFIG.SENTIUS.abilities.dex.label;
    } else if ( (parts[0] === "prof") || (property === "attributes.prof") ) {
      return game.i18n.localize("SENTIUS.Proficiency");
    }
    return property;
  }
}
