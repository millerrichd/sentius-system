...
export default class EnchantSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/sentius/templates/activity/enchant-effect.hbs",
      templates: [
        "systems/sentius/templates/activity/parts/enchant-enchantments.hbs",
        "systems/sentius/templates/activity/parts/enchant-restrictions.hbs"
      ]
    }
  };
  ...
  async _prepareEffectContext(context) {
    ...
    context.typeOptions = [
      { value: "", label: game.i18n.localize("SENTIUS.ENCHANT.FIELDS.restrictions.type.Any") },
    ...
    context.propertyOptions = (CONFIG.SENTIUS.validProperties[type] ?? [])
      .map(value => ({ value, label: CONFIG.SENTIUS.itemProperties[value]?.label ?? value }));
  ...
  _getTabs() {
    ...
    tabs.effect.label = "SENTIUS.ENCHANT.SECTIONS.Enchanting";
    ...
    tabs.effect.tabs = this._markTabs({
      enchantments: {
        ...
        label: "SENTIUS.ENCHANT.SECTIONS.Enchantments"
      },
      restrictions: {
        id: "restrictions", group: "effect", icon: "fa-solid fa-ban",
        label: "SENTIUS.ENCHANT.SECTIONS.Restrictions"
      }
    });
    return tabs;
  }
