...
export default class CopyableTextElement extends HTMLElement {
  ...
  connectedCallback() {
    ...
    button.ariaLabel = this.getAttribute("label") ?? game.i18n.localize("SENTIUS.Copy");
  ...
  _onClick(event) {
    ...
    game.tooltip.activate(event.target, { text: game.i18n.format("SENTIUS.Copied", { value }), direction: "UP" });
  }
}
