...
window.customElements.define("sentius-checkbox", CheckboxElement);
window.customElements.define("sentius-effects", EffectsElement);
window.customElements.define("sentius-icon", IconElement);
window.customElements.define("sentius-inventory", InventoryElement);
