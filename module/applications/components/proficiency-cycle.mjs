...
export default class ProficiencyCycleElement extends AdoptedStyleSheetMixin(
  ...
  static CSS = `
    ...
    div { --_fill: var(--proficiency-cycle-enabled-color, var(--sentius-color-blue)); }
    div:has(:disabled, :focus-visible) { --_fill: var(--proficiency-cycle-disabled-color, var(--sentius-color-gold)); }
  ...
  _refresh() {
    ...
    this._internals.ariaValueText = CONFIG.SENTIUS.proficiencyLevels[this._value];
