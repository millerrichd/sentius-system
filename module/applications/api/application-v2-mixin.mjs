  ...
  class BaseApplication5e extends HandlebarsApplicationMixin(Base) {
    ...
    async _renderFrame(options) {
      ...
      if ( (options.window?.icon ?? "").includes(".") ) {
        ...
        const newIcon = document.createElement(options.window.icon?.endsWith(".svg") ? "sentius-icon" : "img");
    ...
    _disableFields() {
      const selector = `.window-content :is(${[
        "INPUT", "SELECT", "TEXTAREA", "BUTTON", "SENTIUS-CHECKBOX", "COLOR-PICKER", "DOCUMENT-TAGS",
