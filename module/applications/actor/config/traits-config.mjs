...
export default class TraitsConfig extends BaseConfigSheet {
  ...
  static PARTS = {
    traits: {
      template: "systems/sentius/templates/actors/config/traits-config.hbs"
    }
  };
   ...
   */
  get otherLabel() {
    return game.i18n.localize("SENTIUS.ProficiencyOther");
  }
  ...
  _initializeApplicationOptions(options) {
    ...
    if ( !CONFIG.SENTIUS.traits[options.trait] ) throw new Error(
      `Cannot instantiate TraitsConfig with a trait not defined in CONFIG.SENTIUS.traits: ${options.trait}.`
    );
  ...
  _processFormData(event, form, formData) {
    ...
    if ( CONFIG.SENTIUS.traits[this.options.trait].dataType !== Number ) {
